...
//public class PeertubeSearchExtractor: SearchExtractor {
//
//    // MARK: - Properties
//    
...
//    init(service: StreamingService, linkHandler: SearchQueryHandler, sepia: Bool = false) {
//        self.sepia = sepia
...
//    public override func getInitialPage() throws -> InfoItemsPage<StreamInfoItem> {
